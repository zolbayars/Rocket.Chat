...
class Teli {
	constructor() {
		this.token = RocketChat.settings.get('SMS_Teli_token');
		this.address = RocketChat.settings.get('SMS_Teli_restful_address');
		this.from = RocketChat.settings.get('SMS_Teli_from_number');
	}
...
RocketChat.SMS.registerService('teli', Teli);
